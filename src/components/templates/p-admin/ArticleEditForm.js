...
export default function ArticleEditForm({ selectedArticle, onSubmit, onCancel }) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    ...
    >
      <h3 className="text-2xl font-semibold text-gray-800">{selectedArticle? "✏️ Edit Article" :  "Add Article"}</h3>
