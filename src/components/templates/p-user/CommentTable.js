  ...
  return (
    <>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full border border-gray-300 shadow-sm text-center">
          <thead>
            <tr className="bg-gray-100 text-gray-700">
              
              <th className="p-1 border border-gray-300">Product</th>
              <th className="p-1 border border-gray-300">Rate</th>
              <th className="p-1 border border-gray-300">State</th>
            ...
            {comments?.length > 0 ? (
              comments.map((comment) => (
                <tr key={comment._id} className="hover:bg-gray-50">
                  ...
                  <td className="p-1 border border-gray-300 space-x-2">
                    <button
